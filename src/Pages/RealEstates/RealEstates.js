...
import { fetchOpinions, fetchRealEstates } from '../../API_ENDPOINTS/API_ENDPOINTS'
...
const ReslEstates = () => {
    ...
    const { isLoading, error, articles } = useNewsFetcher(fetchRealEstates)
