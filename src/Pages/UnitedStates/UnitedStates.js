...
import { fetchOpinions, fetchUnitedStates } from '../../API_ENDPOINTS/API_ENDPOINTS'
...
const UnitesStates = () => {
    ...
    const { isLoading, error, articles } = useNewsFetcher(fetchUnitedStates)
